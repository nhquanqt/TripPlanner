...
urlpatterns = [
    ...
    url(r'^changeuserbyid', views.changeUserbyID, name='changeuserbyid'),
    #http://192.168.1.3:8080/changeuserbyid?id=1&name=abc&date=12&place=HN
    ...
    url(r'^changetripbyID', views.getTripByID, name="tripbyid"),
    #http://192.168.1.3:8080/tripbyid?id=1
